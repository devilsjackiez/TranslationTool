...
$subject = "Confirm Approved Translation Email";
...
$updateContent = '<div><strong>Type : <a>' . $ModuleType . '</a></strong></div>
                      ...
                      <div><strong>Translation Files : <a href="http://hrm.clbs.co.th/addonplugin/requesttranslation/GenPDFSugar.php?TransID='.$URequestTransID.'">Translation File</a></strong></div>';
