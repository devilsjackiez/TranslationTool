...
/*$this->fontdata = array(
    "opensans" => array(
        'R' => "OpenSans-Regular.ttf","sans-serif",
        'B' => "OpenSans-Semibold.ttf","sans-serif",
        'I' => "OpenSans-LightItalic.ttf","sans-serif",
        'BI' => "OpenSans-Semibolditalic.ttf","sans-serif"
    ),
);*/

$this->fontdata = array(
    "kochimincho" => array(
        'R' => "kochi-mincho-subst.ttf"
    ),
    "opensans" => array(
        'R' => "OpenSans-Regular.ttf","sans-serif",
        'B' => "OpenSans-Semibold.ttf","sans-serif",
